...
final class PromptBuilder
{
    ...
    public static function article(array $payload, array $job): string
    {
        return self::base($job)
            ...
            . "\nProvide image_search_query as a concrete 3 to 6 word English scene containing a person or object, an action, and a place when relevant, suitable for an openly licensed editorial photograph or illustration. Prefer a scene such as 'adult studying online course laptop' over abstract terms such as comparison, success, SEO, or strategy. Do not request logos, UI, or text. Provide a natural Japanese image_alt that describes the intended scene without keyword stuffing."
